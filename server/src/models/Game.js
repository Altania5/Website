...
gameSchema.methods.getProductionRatesPerSecond = function () {
  ...
  const solarPanels = Number((this.generators && this.generators.solarPanels) || 0);
  ...
  return { energy: energyRate, altanerite: altaneriteRate, homainionite: homainioniteRate };
};
