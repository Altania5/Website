...
const linkStyle = ({ isActive }) => ({
  ...
  background: isActive ? "linear-gradient(135deg, rgba(96,165,250,0.85), rgba(139,92,246,0.75))" : "rgba(15,23,42,0.6)",
...
const GameNav = () => {
  return (
    <div style={{ marginBottom: 20, display: "flex", gap: 10, flexWrap: "wrap", padding: "8px 12px", background: "rgba(15, 23, 42, 0.6)", borderRadius: 12, border: "1px solid rgba(148,163,184,0.2)", boxShadow: "inset 0 1px 0 rgba(255,255,255,0.05)" }}>
